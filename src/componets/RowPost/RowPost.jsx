...
function RowPost(props) {
  ...
  return (
    <div
      ...
      style={{ marginTop: props.first ? "-4rem" : undefined }}
    >
      {PopupMessage}
      {removePopupMessage}
                      ...
                      <img
                        ...
                        className={
                          props.movieData != null
                            ? "border-b-4 border-[#A3FF4D] rounded-sm"
                            : "rounded-sm"
                        }
                        src={
                          obj.backdrop_path
                ...
                <Fade bottom duration={500}>
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-neutral-800 outline-none focus:outline-none">
                    ...
                    <div className="flex ml-4 items-center -mt-14">
                      <button
                        className="flex items-center justify-center bg-[#7CFC00]/90 text-white active:bg-[#7CFC00]/90 font-medium sm:font-bold uppercase text-xs px-4 sm:px-6 md:text-sm  py-2 rounded shadow hover:shadow-lg cursor-pointer outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                        type="button"
                        onClick={() => {
                    ...
                    <div className="sm:flex items-center justify-end p-2 rounded-b">
                      ...
                      <div className="flex justify-between p-2">
                        <button
                          className="group flex items-center justify-center border-[0.7px] border-white text-white font-medium sm:font-bold text-xs px-4 mr-4 sm:px-6 md:text-sm  py-3 rounded shadow hover:shadow-lg hover:bg-white hover:text-[#A3FF4D] outline-none focus:outline-none mb-1 ease-linear transition-all duration-150"
                          type="button"
                          onClick={() => addToMyList(moviePopupInfo)}
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-6 w-6 mr-1 text-white hover:text-[#A3FF4D] group-hover:text-[#A3FF4D] ease-linear transition-all duration-150"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth={2}
                        ...
                        <button
                          className="flex items-center text-[#A3FF4D] background-transparent font-medium sm:font-bold uppercase px-2 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                          type="button"
                          onClick={() => setShowModal(false)}
                        >
                          <svg
