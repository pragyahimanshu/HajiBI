        ...
        <Fade>
          <div className="bg-[#000000bf] p-5 md:p-12 rounded-md">
              ...
              <div>
                ...
                <div className="flex justify-between cursor-pointer mb-4 md:mb-8">
                  ...
                  <img
                    onClick={() =>
                      updateProfilePic(
                        "https://upload.wikimedia.org/wikipedia/commons/0/0b/HajiBI-avatar.png"
                      )
                    }
                    className="w-16 h-16 rounded-md cursor-pointer"
                    src="https://upload.wikimedia.org/wikipedia/commons/0/0b/HajiBI-avatar.png"
                  />
                  <img
                    onClick={() =>
                      updateProfilePic(
            ...
            <div className="flex justify-between mt-4">
              <button
                onClick={SignOut}
                className="flex items-center border-[0.7px] border-white text-white font-medium sm:font-bold text-xs px-14 md:px-24 md:text-xl  py-3 rounded shadow hover:shadow-lg hover:bg-white hover:border-white hover:text-[#A3FF4D] outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              {userName != "" || newProfielPic != "" ? (
                <button
                  ...
                  className="flex items-center bg-[#A3FF4D] text-white font-medium sm:font-bold text-xs px-10 md:px-16 md:text-xl  py-3 rounded shadow hover:shadow-lg hover:bg-white hover:text-[#A3FF4D] outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
